...
**YOU ARE IN: `kots_lint/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/kots_lint/` (rig root) or other directories
...
**Your mail address:** `kots_lint/polecats/furiosa`
**Your rig:** kots_lint
**Your Witness:** `kots_lint/witness`
...
| Ask Witness for help | `gt mail send kots_lint/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`kots_lint/witness`) when:
...
```bash
gt mail send kots_lint/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
